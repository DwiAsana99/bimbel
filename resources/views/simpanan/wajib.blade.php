    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Rincian Simpanan Wajib Anggota</h3>
          <div class="box-tools">
      ...
      <div class="modal-content">
        ...
        {{ csrf_field() }} {{ method_field('POST') }}
          <div class="modal-header">
            ...
            <h4 class="modal-title">Setoran Simpanan Wajib</h4>
          </div>
...
<script type="text/javascript">
  $( document ).ready(function() {
    ...
    var table = $('#table').DataTable({
        ...
        ajax: "{{ route('simpanan.wajib.dt', ['rek' => $NoRek]) }}",
        columns: [
    ...
    $('#btnstore').click(function () {
      $('.modal-title').text('Setoran Simpanan Wajib');
      $('#txt-form').text('Setoran');
      $('#modal form').attr('action', "{{ route('simpanan.wajib.setor', ['rek' => $NoRek]) }}");
      aksi = 1;
    });

    $('#btntarik').click(function () {
      $('.modal-title').text('Penarikan Simpanan Wajib');
      $('#txt-form').text('Penarikan');
      $('#modal form').attr('action', "{{ route('simpanan.wajib.tarik', ['rek' => $NoRek]) }}");
      aksi = 2;
    });
